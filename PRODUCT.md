...
- Two more sites the owner wrote and hosts (owner-stated 2026-09-16): cabin-thingvellir.com (Next.js on Railway; a lakeside cabin in Þingvellir National Park) and thssarch.com (Next.js on Vercel; portfolio of the architect Þórunn Sigurrós). Also katbjo.github.io (plain HTML/CSS on GitHub Pages; academic site for Katrín Björnsdóttir, the owner's wife). Hnykill (github.com/MattiSig/hnykill, live on Railway): a World Cup 2026 family quiz built from a phone-based Claude session on holiday; requirement was that kids could compete against adults (owner-stated). Captures in `web/static/img/`.
